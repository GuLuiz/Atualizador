...
$plugins_info = [
    'converttize-player' => [ // <--- O SLUG DO SEU PLUGIN. DEVE SER EXATAMENTE IGUAL AO QUE VOCÊ USA EM Puc_v4_Factory::buildUpdateChecker()
        ...
        'version'        => '1.0.6', // <--- A ÚLTIMA VERSÃO DISPONÍVEL DO SEU PLUGIN. (MAIOR QUE A ATUAL INSTALADA PARA DISPARAR ATUALIZAÇÃO)
        'download_url'   => 'https://github.com/GuLuiz/Converttize/releases/download/v1.0.6/converttize-player-1.0.6.zip', // <--- URL DIRETA PARA O ARQUIVO ZIP DA SUA RELEASE NO GITHUB
        ...
        'upgrade_notice' => 'Uma nova versão do Converttize (1.0.6) está disponível com melhorias e correções. Recomenda-se a atualização.', // Mensagem exibida no painel de atualizações do WP
        'sections'       => [
            'description' => 'Player minimalista com UX fluida, botões próprios e desbloqueio inteligente para o WordPress.',
            'changelog'   => '<h4>Versão 1.0.6</h4><ul><li>Melhoria na barra de progresso para vídeos curtos (Reels).</li><li>Otimização na inicialização do player.</li><li>Correção de pequenos bugs de interface.</li></ul><h4>Versão 1.0.6</h4><ul><li>Lançamento inicial.</li></ul>',
        ],
